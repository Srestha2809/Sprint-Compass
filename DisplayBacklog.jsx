...
const DisplayBacklog = (props) => {
  ...
  const addSubTask = () => {
    ...
    setNew({ description: "", descBool: false, actualhour: 0, hourBool: false, reestimate: 0, reBool: false });
  };
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell>
                <Button onClick={addSubTask} disabled={!newSub.descBool || !newSub.hourBool || !newSub.reBool}>Add Subtask</Button>
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
